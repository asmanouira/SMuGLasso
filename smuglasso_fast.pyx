...
def elasticnet_path_logistic(double[::1, :] X, double[::1] y, double[::1] beta,
    ...
    """
    ElasticNet path solver for logistic loss.
    """
...
def elasticnet_path_quadratic(double[::1, :] X, double[::1] y, double[::1] beta,
                              double[::1] XTR, double[::1] residual, double dual_scale,
                              int n_samples, int n_features, double lambda1, double lambda2,
                              int max_iter, int f, double tol, int screen, 
                              int[::1] disabled_features, int strong_warm_start=0):
    """
    ElasticNet path solver for quadratic loss.
    """
